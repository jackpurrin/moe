...
`;
document
    .getElementById('c_widget')
    .innerHTML = v_mainHtml;
...
function getComments() {
    ...
    if (s_commentsOpen) {
        document
            .getElementById(`entry.${s_nameId}`)
            .value = '';
        document
            .getElementById(`entry.${s_websiteId}`)
            .value = '';
        document
            .getElementById(`entry.${s_textId}`)
            .value = ''
    }
...
function convertTimestamp(timestamp) {
    ...
    return [
        offsetDate.toLocaleString(),
        offsetDate.toLocaleDateString()
    ]
}
function isDST(date) {
    const dstStart = [

(function () {
...
})()(
    {
                ...
                !(function () {
                        ...
                        s = {
                            ...
                            each: function (e, n, i) {
                                if (null != e)
                                    ...
                                    else if (e.length === +e.length) for (var r = 0, s = e.length; r < s; r++) n.call(i, e[r], r, e);
                    ...
                    s.each({ listenTo: "on", listenToOnce: "once" }, function (t, e) {
                        ...
                        (r.mixin = function (t) {
                            return (
                                s.each(
                                    ["on", "once", "off", "trigger", "stopListening", "listenTo", "listenToOnce", "bind", "unbind"],
                                    function (e) {
                                        t[e] = this[e];
                                    },
                                    this
                        ...
                        "undefined" != typeof exports
                            ? ("undefined" != typeof module && module.exports && (exports = module.exports = r), (exports.BackboneEvents = r))
        ...
        8: [
            function (require, module, exports) {
                ...
                var assign = createAssigner(function (r, e) {
                    ...
                    else for (var t in e) hasOwnProperty.call(e, t) && assignValue(r, t, e[t]);
                });
                function keys(r) {
            ...
            function (require, module, exports) {
                ...
                function querystringify(e, n) {
                    ...
                    for (t in ("string" != typeof n && (n = "?"), e))
                        if (has.call(e, t)) {
                            if (((r = e[t]) || (null !== r && r !== undef && !isNaN(r)) || (r = ""), (t = encode(t)), (r = encode(r)), null === t || null === r)) continue;
                            o.push(t + "=" + r);
                        }
        ...
        21: [
            function (require, module, exports) {
                ...
                (FacadeJS.prototype._transportClose = function (t, s) {
                    iframeUtils.postMessage("c", JSON.stringify([t, s]));
                }),
        ...
        22: [
                                                ...
                                                if (n.windowId === iframeUtils.currentWindowId)
                                                    switch (n.type) {
                                                        case "s":
                                                            ...
                                                            if (!urlUtils.isOriginEqual(f, loc.href) || !urlUtils.isOriginEqual(u, loc.href))
                                                                throw new Error("Can't connect to different domain from within an iframe. (" + loc.href + ", " + f + ", " + u + ")");
            ...
            { "./facade": 21, "./info-iframe-receiver": 24, "./location": 27, "./utils/event": 60, "./utils/iframe": 61, "./utils/url": 66, _process: 12, debug: 3 },
        ],
        23: [
            function (require, module, exports) {
                (function (process) {
                        ...
                        function InfoAjax(e, t) {
                            ...
                            (this.xo = new t("GET", e)),
                                this.xo.once("finish", function (e, t) {
                                    ...
                                    i.emit("finish", s, o), i.removeAllListeners();
                                });
                        }
            ...
            { "./utils/object": 63, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        24: [
            function (require, module, exports) {
                "use strict";
                ...
                function InfoReceiverIframe(e) {
                    ...
                    EventEmitter.call(this),
                        ...
                        this.ir.once("finish", function (e, i) {
                            (r.ir = null), r.emit("message", JSON.stringify([e, i]));
                        });
                }
            ...
            { "./info-ajax": 23, "./transport/sender/xhr-local": 51, events: 17, inherits: 6 },
        ],
        25: [
            function (require, module, exports) {
            ...
            { "./info-iframe-receiver": 24, "./transport/iframe": 36, "./utils/event": 60, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        26: [
            function (require, module, exports) {
                (function (process) {
            ...
            },
            {
                "./info-ajax": 23,
                "./info-iframe": 25,
                "./transport/sender/xdr": 48,
                "./transport/sender/xhr-cors": 49,
                "./transport/sender/xhr-fake": 50,
                "./transport/sender/xhr-local": 51,
                "./utils/url": 66,
                _process: 12,
                debug: 3,
                events: 17,
        ...
        28: [
                    ...
                    (function () {
                        ...
                        function SockJS(t, e, r) {
                            ...
                            EventTarget.call(this),
                                ...
                                (this.extensions = ""),
                                (this.protocol = ""),
                                (r = r || {}).protocols_whitelist && log.warn("'protocols_whitelist' is DEPRECATED. Use 'transports' instead."),
                            ...
                            if ("https:" === loc.protocol && !i && !urlUtils.isLoopbackAddr(o.hostname)) throw new Error("SecurityError: An insecure SockJS connection may not be initiated from a page loaded over HTTPS");
                            e ? Array.isArray(e) || (e = [e]) : (e = []);
                            var n = e.sort();
                            n.forEach(function (t, e) {
                                if (!t) throw new SyntaxError("The protocols entry '" + t + "' is invalid.");
                                if (e < n.length - 1 && t === n[e + 1]) throw new SyntaxError("The protocols entry '" + t + "' is duplicated.");
                            });
                            ...
                            (this._origin = a ? a.toLowerCase() : null),
                                ...
                                (this._urlInfo = { nullOrigin: !browser.hasDomain(), sameOrigin: urlUtils.isOriginEqual(this.url, loc.href), sameScheme: urlUtils.isSchemeEqual(this.url, loc.href) }),
                        ...
                        "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:main")),
                            ...
                            (SockJS.prototype._connect = function () {
                                for (var t = this._transports.shift(); t; t = this._transports.shift()) {
                                    if (
                                        ...
                                        t.needBody && (!global.document.body || (void 0 !== global.document.readyState && "complete" !== global.document.readyState && "interactive" !== global.document.readyState)))
                                    )
                                        return debug("waiting for body"), this._transports.unshift(t), void eventUtils.attachEvent("load", this._connect.bind(this));
                            ...
                            (SockJS.prototype._transportClose = function (t, e) {
                                debug("_transportClose", this.transport, t, e),
                                    ...
                                    userSetCode(t) || 2e3 === t || this.readyState !== SockJS.CONNECTING ? this._close(t, e) : this._connect();
                            }),
                            (SockJS.prototype._open = function () {
                                debug("_open", this._transport && this._transport.transportName, this.readyState),
                                    this.readyState === SockJS.CONNECTING
                                        ? (this._transportTimeoutId && (clearTimeout(this._transportTimeoutId), (this._transportTimeoutId = null)),
                            ...
                            (SockJS.prototype._close = function (t, e, r) {
                                ...
                                var s = !1;
                                if ((this._ir && ((s = !0), this._ir.close(), (this._ir = null)), this._transport && (this._transport.close(), (this._transport = null), (this.transport = null)), this.readyState === SockJS.CLOSED))
            ...
            },
            {
                "./event/close": 16,
                "./event/event": 18,
                "./event/eventtarget": 19,
                "./event/trans-message": 20,
                "./iframe-bootstrap": 22,
                "./info-receiver": 26,
                "./location": 27,
                "./shims": 29,
                    ...
                    ? (function () {
                          ...
                          StringPrototype.split = function (r, e) {
                              ...
                              var i,
                                  ...
                                  a = 0;
                              for (
                                  r = new RegExp(r.source, l + "g"), n += "", t || (i = new RegExp("^" + r.source + "$(?!\\s)", l)), e = void 0 === e ? -1 >>> 0 : ToUint32(e);
                                  (o = r.exec(n)) &&
                                  !(
                                      ...
                                      o.length > 1 && o.index < n.length && ArrayPrototype.push.apply(c, o.slice(1)),
                                      (p = o[0].length),
                                      (a = s),
                                      c.length >= e)
                                  );
        ...
        30: [
            ...
            {
                "./transport/eventsource": 34,
                "./transport/htmlfile": 35,
                "./transport/jsonp-polling": 37,
                "./transport/lib/iframe-wrap": 40,
                "./transport/websocket": 52,
                "./transport/xdr-polling": 53,
                "./transport/xdr-streaming": 54,
                "./transport/xhr-polling": 55,
                "./transport/xhr-streaming": 56,
            },
        ],
        31: [
            function (require, module, exports) {
                        ...
                        "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:browser:xhr")),
                            ...
                            (AbstractXHRObject.prototype._cleanup = function (t) {
                                if ((debug("cleanup"), this.xhr)) {
                                    if ((this.removeAllListeners(), utils.unloadDel(this.unloadRef), (this.xhr.onreadystatechange = function () {}), this.xhr.ontimeout && (this.xhr.ontimeout = null), t))
                                        try {
                                            this.xhr.abort();
                                        } catch (t) {}
            ...
            { "../../utils/event": 60, "../../utils/url": 66, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        32: [
            function (require, module, exports) {
                (function (global) {
        ...
        34: [
            ...
            { "./lib/ajax-based": 38, "./receiver/eventsource": 43, "./sender/xhr-cors": 49, eventsource: 32, inherits: 6 },
        ],
        35: [
            function (require, module, exports) {
                "use strict";
            ...
            { "./lib/ajax-based": 38, "./receiver/htmlfile": 44, "./sender/xhr-local": 51, inherits: 6 },
        ],
        36: [
            function (require, module, exports) {
                (function (process) {
                    (function () {
                        ...
                        var inherits = require("inherits"),
                            ...
                            random = require("../utils/random"),
                            debug = function () {};
                        function IframeTransport(e, t, s) {
                            if (!IframeTransport.enabled()) throw new Error("Transport created when disabled");
                            EventEmitter.call(this);
                            var r = this;
                            (this.origin = urlUtils.getOrigin(s)), (this.baseUrl = s), (this.transUrl = t), (this.transport = e), (this.windowId = random.string(8));
                            var i = urlUtils.addPath(s, "/iframe.html") + "#" + this.windowId;
                            debug(e, t, i),
                                (this.iframeObj = iframeUtils.createIframe(i, function (e) {
                                    debug("err callback"), r.emit("close", 1006, "Unable to load an iframe (" + e + ")"), r.close();
                                })),
                        ...
                        "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:transport:iframe")),
                            ...
                            (IframeTransport.prototype._message = function (e) {
                                if ((debug("message", e.data), urlUtils.isOriginEqual(e.origin, this.origin))) {
                                    ...
                                    if (t.windowId === this.windowId)
                                        switch (t.type) {
                                            case "s":
                                                this.iframeObj.loaded(), this.postMessage("s", JSON.stringify([version, this.transport, this.transUrl, this.baseUrl]));
                                                break;
                                            case "t":
                                            ...
                                            case "c":
                                                ...
                                                this.emit("close", s[0], s[1]), this.close();
                                        }
                            ...
                            (IframeTransport.prototype.postMessage = function (e, t) {
                                debug("postMessage", e, t), this.iframeObj.post(JSON.stringify({ windowId: this.windowId, type: e, data: t || "" }), this.origin);
                            }),
            ...
            { "../utils/event": 60, "../utils/iframe": 61, "../utils/random": 64, "../utils/url": 66, "../version": 67, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        37: [
            function (require, module, exports) {
                (function (global) {
            ...
            { "./lib/sender-receiver": 42, "./receiver/jsonp": 45, "./sender/jsonp": 47, inherits: 6 },
        ],
        38: [
            function (require, module, exports) {
                (function (process) {
            ...
            { "../../utils/url": 66, "./sender-receiver": 42, _process: 12, debug: 3, inherits: 6 },
        ],
        39: [
            function (require, module, exports) {
                (function (process) {
            ...
            { _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        40: [
            function (require, module, exports) {
                (function (global) {
            ...
            { "../../utils/object": 63, "../iframe": 36, inherits: 6 },
        ],
        41: [
            function (require, module, exports) {
                (function (process) {
        ...
        42: [
            ...
            { "../../utils/url": 66, "./buffered-sender": 39, "./polling": 41, _process: 12, debug: 3, inherits: 6 },
        ],
        43: [
            function (require, module, exports) {
                (function (process) {
            ...
            { _process: 12, debug: 3, events: 17, eventsource: 32, inherits: 6 },
        ],
        44: [
            function (require, module, exports) {
                (function (process, global) {
                    (function () {
                        ...
                        function HtmlfileReceiver(e) {
                            ...
                            iframeUtils.polluteGlobalNamespace(),
                                ...
                                (e = urlUtils.addQuery(e, "c=" + decodeURIComponent(iframeUtils.WPrefix + "." + this.id))),
            ...
            { "../../utils/iframe": 61, "../../utils/random": 64, "../../utils/url": 66, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        45: [
            function (require, module, exports) {
                (function (process, global) {
            ...
            { "../../utils/browser": 58, "../../utils/iframe": 61, "../../utils/random": 64, "../../utils/url": 66, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        46: [
            function (require, module, exports) {
                (function (process) {
        ...
        47: [
            function (require, module, exports) {
                (function (process, global) {
                    (function () {
                        ...
                        function createForm() {
                            debug("createForm"),
                                ((form = global.document.createElement("form")).style.display = "none"),
            ...
            { "../../utils/random": 64, "../../utils/url": 66, _process: 12, debug: 3 },
        ],
        48: [
            function (require, module, exports) {
                (function (process, global) {
                        ...
                        "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:sender:xdr")),
                            ...
                            (XDRObject.prototype._cleanup = function (e) {
                                if ((debug("cleanup", e), this.xdr)) {
                                    if ((this.removeAllListeners(), eventUtils.unloadDel(this.unloadRef), (this.xdr.ontimeout = this.xdr.onerror = this.xdr.onprogress = this.xdr.onload = null), e))
                                        try {
                                            this.xdr.abort();
                                        } catch (e) {}
            ...
            { "../../utils/browser": 58, "../../utils/event": 60, "../../utils/url": 66, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        49: [
            function (require, module, exports) {
                "use strict";
        ...
        52: [
            ...
            { "../utils/event": 60, "../utils/url": 66, "./driver/websocket": 33, _process: 12, debug: 3, events: 17, inherits: 6 },
        ],
        53: [
            function (require, module, exports) {
                "use strict";
            ...
            { "./lib/ajax-based": 38, "./receiver/xhr": 46, "./sender/xdr": 48, "./xdr-streaming": 54, inherits: 6 },
        ],
        54: [
            function (require, module, exports) {
                "use strict";
            ...
            { "./lib/ajax-based": 38, "./receiver/xhr": 46, "./sender/xdr": 48, inherits: 6 },
        ],
        55: [
            function (require, module, exports) {
                "use strict";
            ...
            { "./lib/ajax-based": 38, "./receiver/xhr": 46, "./sender/xhr-cors": 49, "./sender/xhr-local": 51, inherits: 6 },
        ],
        56: [
            function (require, module, exports) {
                (function (global) {
            ...
            { "../utils/browser": 58, "./lib/ajax-based": 38, "./receiver/xhr": 46, "./sender/xhr-cors": 49, "./sender/xhr-local": 51, inherits: 6 },
        ],
        57: [
            function (require, module, exports) {
                (function (global) {
        ...
        61: [
                        ...
                        "production" !== process.env.NODE_ENV && (debug = require("debug")("sockjs-client:utils:iframe")),
                            (module.exports = {
                                ...
                                postMessage: function (e, o) {
                                    global.parent !== global ? global.parent.postMessage(JSON.stringify({ windowId: module.exports.currentWindowId, type: e, data: o || "" }), "*") : debug("Cannot postMessage, no parent window.", e, o);
                                },
                                createIframe: function (e, o) {
                                    var t,
                                        n,
                                        l = global.document.createElement("iframe"),
                                        r = function () {
                                    ...
                                    return (
                                        ...
                                        global.document.body.appendChild(l),
                                        (t = setTimeout(function () {
                                            u("timeout");
                                        }, 15e3)),
                                        (n = eventUtils.unloadAdd(i)),
                                        {
                                            post: function (e, o) {
                                                debug("post", e, o),
                                                    setTimeout(function () {
                                                        try {
                                                            l && l.contentWindow && l.contentWindow.postMessage(e, o);
                                                        } catch (e) {}
                                                    }, 0);
                                            },
                                            cleanup: i,
                                ...
                                createHtmlfile: function (e, o) {
                                    var t,
                                        n,
                                        l,
                                        r = ["Active"].concat("Object").join("X"),
                                        i = new global[r]("htmlfile"),
                                        u = function () {
                                            clearTimeout(t), (l.onerror = null);
                                        },
                                        a = function () {
                                            i && (u(), eventUtils.unloadDel(n), l.parentNode.removeChild(l), (l = i = null), CollectGarbage());
                                        },
                                        d = function (e) {
            ...
            { "./browser": 58, "./event": 60, _process: 12, debug: 3 },
        ],
        62: [
            function (require, module, exports) {
                (function (global) {
                                                ...
                                                e &&
                                                    ("websocket" !== e.transportName || !1 !== r.websocket
                                                        ? t.length && -1 === t.indexOf(e.transportName)
                                                            ...
                                                            : e.enabled(r)
                                                            ? (debug("enabled", e.transportName), a.main.push(e), e.facadeTransport && a.facade.push(e.facadeTransport))
        ...
        66: [
            ...
            { _process: 12, debug: 3, "url-parse": 68 },
        ],
        67: [
            function (require, module, exports) {
        ...
        68: [
                ...
                (function (global) {
                    (function () {
                        ...
                        var rules = [
                                ...
                                ["?", "query"],
                                function (e, o) {
                                    return isSpecial(o.protocol) ? e.replace(/\\/g, "/") : e;
                                },
                                ["/", "pathname"],
                                ["@", "auth", 1],
                                [NaN, "host", void 0, 1, 1],
                        ...
                        function lolcation(e) {
                            var o,
                                t = ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}).location || {},
                                r = {},
                                s = typeof (e = e || t);
                            if ("blob:" === e.protocol) r = new Url(unescape(e.pathname), {});
                            else if ("string" === s) for (o in ((r = new Url(e, {})), ignore)) delete r[o];
                            else if ("object" === s) {
                        ...
                        function extractProtocol(e, o) {
                            (e = (e = trimLeft(e)).replace(CRHTLF, "")), (o = o || {});
                            var t,
                                r = protocolre.exec(e),
                                ...
                                l = 0;
                            return (
                                a ? (n ? ((t = r[2] + r[3] + r[4]), (l = r[2].length + r[3].length)) : ((t = r[2] + r[4]), (l = r[2].length))) : n ? ((t = r[3] + r[4]), (l = r[3].length)) : (t = r[4]),
                                "file:" === s ? l >= 2 && (t = t.slice(2)) : isSpecial(s) ? (t = r[4]) : s ? a && (t = t.slice(2)) : l >= 2 && isSpecial(o.protocol) && (t = r[4]),
                                { protocol: s, slashes: a || isSpecial(s), slashesCount: l, rest: t }
                            );
                        }
                        function resolve(e, o) {
                            if ("" === e) return o;
                            for (var t = (o || "/").split("/").slice(0, -1).concat(e.split("/")), r = t.length, s = t[r - 1], a = !1, n = 0; r--; )
                                "." === t[r] ? t.splice(r, 1) : ".." === t[r] ? (t.splice(r, 1), n++) : n && (0 === r && (a = !0), t.splice(r, 1), n--);
                            return a && t.unshift(""), ("." !== s && ".." !== s) || t.push(""), t.join("/");
                        }
                        function Url(e, o, t) {
                            if (((e = (e = trimLeft(e)).replace(CRHTLF, "")), !(this instanceof Url))) return new Url(e, o, t);
                            var r,
                                s,
                                a,
                                n,
                                ...
                                u = 0;
                            for (
                                "object" !== c && "string" !== c && ((t = o), (o = null)),
                                    t && "function" != typeof t && (t = qs.parse),
                                    o = lolcation(o),
                                    r = !(s = extractProtocol(e || "", o)).protocol && !s.slashes,
                                    h.slashes = s.slashes || (r && o.slashes),
                                    h.protocol = s.protocol || o.protocol || "",
                                    e = s.rest,
                                    (("file:" === s.protocol && (2 !== s.slashesCount || windowsDriveLetter.test(e))) || (!s.slashes && (s.protocol || s.slashesCount < 2 || !isSpecial(h.protocol)))) && (p[3] = [/(.*)/, "pathname"]);
                                u < p.length;
                                u++
                            )
                                "function" != typeof (n = p[u])
                                    ? ((a = n[0]),
                                      (i = n[1]),
                                      a != a
                                          ? (h[i] = e)
                                          : "string" == typeof a
                                          ? ~(l = "@" === a ? e.lastIndexOf(a) : e.indexOf(a)) && ("number" == typeof n[2] ? ((h[i] = e.slice(0, l)), (e = e.slice(l + n[2]))) : ((h[i] = e.slice(l)), (e = e.slice(0, l))))
                                          : (l = a.exec(e)) && ((h[i] = l[1]), (e = e.slice(0, l.index))),
                                      (h[i] = h[i] || (r && n[3] && o[i]) || ""),
                                      n[4] && (h[i] = h[i].toLowerCase()))
                                    : (e = n(e, h));
                            t && (h.query = t(h.query)),
                                r && o.slashes && "/" !== h.pathname.charAt(0) && ("" !== h.pathname || "" !== o.pathname) && (h.pathname = resolve(h.pathname, o.pathname)),
                                "/" !== h.pathname.charAt(0) && isSpecial(h.protocol) && (h.pathname = "/" + h.pathname),
                                required(h.port, h.protocol) || ((h.host = h.hostname), (h.port = "")),
                                (h.username = h.password = ""),
                                h.auth &&
                                    (~(l = h.auth.indexOf(":"))
                                        ? ((h.username = h.auth.slice(0, l)),
                                          (h.username = encodeURIComponent(decodeURIComponent(h.username))),
                                          (h.password = h.auth.slice(l + 1)),
                                          (h.password = encodeURIComponent(decodeURIComponent(h.password))))
                                        : (h.username = encodeURIComponent(decodeURIComponent(h.auth))),
                                    (h.auth = h.password ? h.username + ":" + h.password : h.username)),
                                (h.origin = "file:" !== h.protocol && isSpecial(h.protocol) && h.host ? h.protocol + "//" + h.host : "null"),
                                (h.href = h.toString());
                        }
                        function set(e, o, t) {
                            var r = this;
                            switch (e) {
                                ...
                                case "hostname":
                                    ...
                                    break;
                                case "host":
                                    (r[e] = o), port.test(o) ? ((o = o.split(":")), (r.port = o.pop()), (r.hostname = o.join(":"))) : ((r.hostname = o), (r.port = ""));
                                    break;
                                case "protocol":
                                ...
                                case "username":
                                case "password":
                                    r[e] = encodeURIComponent(o);
                                    break;
                                case "auth":
                                    var a = o.indexOf(":");
                                    ~a
                                        ? ((r.username = o.slice(0, a)), (r.username = encodeURIComponent(decodeURIComponent(r.username))), (r.password = o.slice(a + 1)), (r.password = encodeURIComponent(decodeURIComponent(r.password))))
                                        : (r.username = encodeURIComponent(decodeURIComponent(o)));
                            }
                            for (var n = 0; n < rules.length; n++) {
                                var l = rules[n];
                                l[4] && (r[l[1]] = r[l[1]].toLowerCase());
                            }
                            return (r.auth = r.password ? r.username + ":" + r.password : r.username), (r.origin = "file:" !== r.protocol && isSpecial(r.protocol) && r.host ? r.protocol + "//" + r.host : "null"), (r.href = r.toString()), r;
                        }
                        function toString(e) {
                            ...
                            var a = s + ((t.protocol && t.slashes) || isSpecial(t.protocol) ? "//" : "");
                            return (
                                t.username
                                    ? ((a += t.username), t.password && (a += ":" + t.password), (a += "@"))
                                    : t.password
                                    ? ((a += ":" + t.password), (a += "@"))
                                    : "file:" !== t.protocol && isSpecial(t.protocol) && !r && "/" !== t.pathname && (a += "@"),
                                (":" === r[r.length - 1] || (port.test(t.hostname) && !t.port)) && (r += ":"),
                                (a += r + t.pathname),
                                (o = "object" == typeof t.query ? e(t.query) : t.query) && (a += "?" !== o.charAt(0) ? "?" + o : o),
                                t.hash && (a += t.hash),
                                a
                            );
                        }
            ...
            { querystringify: 13, "requires-port": 14 },
        ],
        69: [
            function (require, module, exports) {
                module.exports = {
        ...
        70: [
            function (require, module, exports) {
                ...
                function Scaledrone(e, t) {
                    ...
                    (t = assign({}, { autoReconnect: !0, url: null, originalInstance: this, data: null, debug: !1 }, t)),
                        (this.args = arguments),
                        (this.args[1] = t),
                        ...
                        this.emitter.on("open", function () {
                            (r.readyState = States.OPEN),
                                r._sendMessage("handshake", { channel: e, version: 2, client_data: t.data }, {}, function (e, t) {
                            ...
                            if (-1 === ["observable_members", "observable_member_join", "observable_member_leave"].indexOf(t.type)) {
                                ...
                                if (t.error) r.trigger("error", wrapError(t.error));
                                    ...
                                    if ("publish" === t.type) {
                                        ...
                                        if (!s) return;
                                        var c = { data: t.message, id: t.id, timestamp: t.timestamp },
                                            a = t.client_id;
                ...
                function getConnection(e) {
                    return "sockjs" !== e.type && supportsWebsockets()
                        ? isNode
                            ? new config.WS(e.url || config.websocketUrl, config.websocketOptions)
                ...
                Events.mixin(Scaledrone.prototype),
                    ...
                    (Scaledrone.prototype.subscribe = function (e) {
                        ...
                        return (
                            (this.rooms[e] = r),
                            this._sendMessage("subscribe", { room: e, history: t, history_count: t }, { waitForPromise: this.eventPromises.fullyConnected }, function (e) {
            ...
            { "./config": 69, "./room.js": 71, "./sock_events.js": 72, "./utils": 73, "backbone-events-standalone": 2, lie: 7, "lodash.assign": 8, "lodash.get": 9, "lodash.omit": 10, "sockjs-client": 15, ws: undefined },
        ],
        71: [
            function (require, module, exports) {
                "use strict";
                            ...
                            this._history.messages[this._history.nextIndex] &&
                                (function e() {
                                    ...
                                    var i = s.message,
                                        ...
                                        a = s.client_data,
                                        h = s.auth_data,
                                        c = { data: i, timestamp: n, id: o },
                                        u = {};
                                    a && (u.clientData = a),
                                        h && (u.authData = h),
                                        r && ((c.clientId = r), (u.clientId = r)),
                                        Object.keys(u).length > 0 && (c.member = u),
                                        t.trigger("history_message", c),
                                        t._history.messages[t._history.nextIndex] && e();
                                })();
                    }),
                    (module.exports = Room);
            },
            { "./utils": 73, "backbone-events-standalone": 2 },
        ],
        72: [
            function (require, module, exports) {
                "use strict";
